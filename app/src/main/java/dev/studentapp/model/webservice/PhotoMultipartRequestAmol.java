 ...
 *
 */
public class PhotoMultipartRequestAmol extends Request<NetworkResponse> {
...
public PhotoMultipartRequestAmol(String url, Response.ErrorListener errorListener, Response.Listener<NetworkResponse> listener, File imageFile){
